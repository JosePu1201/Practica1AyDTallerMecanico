...
router.put('/actualizar_trabajo', specialistController.updateWorkAssignment);
...
router.post('/agregar_resultado_prueba', specialistController.addTestResult);
...
router.get('/solicitudes_repuestos_asignacion/:id', specialistController.getRequestsReplacementPartsByAssignment);
